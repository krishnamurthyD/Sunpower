...
export default class snp_currencyOldCode extends NavigationMixin(LightningElement) {
...
//                             (SELECT CartId, CurrencyIsoCode, Name, Id FROM CartDeliveryGroups)  
//                            from WebCart where OwnerId =: userId and (Status = 'Active' or Status = 'Checkout' or Status ='Processing') ];
